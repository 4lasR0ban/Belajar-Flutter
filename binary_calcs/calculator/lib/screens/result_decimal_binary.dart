...
class DecimalBinaryResultPage extends StatelessWidget {
  // const BinaryDecimalResultPage({Key? key}) : super(key: key);

  const DecimalBinaryResultPage({required this.masukanDecimalBinary});

  final int masukanDecimalBinary;
